...
class EntityEmbeddingEncoder(): 
    ...
    def fit(self, df, y):
        ...
        model_checkpoint = keras.callbacks.ModelCheckpoint('model_entityembedding.h5', save_best_only=True)
        ...
        self.model = keras.models.load_model('model_entityembedding.h5')
